...
def main(page: Page):
    ...
    def send_click(e):
        ...
        # pub.sendMessage('football', arg={'headline': 'Ronaldo',
        #                          'news': 'Sold for $2M'})
        # Flet built in pub sub version - will it work? YES - doesn't suffer the falling out of scope problem 🎉
        page.pubsub.send_all({'headline': 'Ronaldo',
                                 'news': 'Sold for $2M'})
